...
class MyHomePage extends StatelessWidget {
  ...
  final String name = 'Dimas Abyan Diasta'; 
  final String className = 'PBP C'; 

  // List of items with different colors for each button
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        // Judul aplikasi "bolabelishop" dengan teks putih dan tebal.
        title: const Text(
          'bolabelishop',
          style: TextStyle(
            color: Colors.white,
...
class ItemCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Material(
      // Menentukan warna latar belakang sesuai dengan warna item.
      color: item.color,
